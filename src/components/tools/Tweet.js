        ...
        <>
            ...
            <div className='grid w-full grid-cols-[180px,2em,1fr]'>
              ...
              {user?.isPro ? (
                <ChevronRightIcon
                  ...
                  } h-5 w-5 justify-self-end text-gray-500`}
                />
              ) : (
          ...
          <Disclosure.Panel className='w-full'>
            <div className='grid grid-cols-2'>
              ...
              <div className='flex flex-col text-white'>
                <p className='mb-2 text-sm'>Show metrics</p>
                <Switch
                  ...
                  className={`${
                    options.tweet.metrics.show ? 'bg-primary' : 'bg-[#212121]'
                  }
          relative inline-flex h-[20px] w-[52px] shrink-0 cursor-pointer items-center justify-self-end rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none  focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}>
            ...
            pointer-events-none inline-block h-[15px] w-[15px] transform rounded-full bg-white shadow-lg ring-0 transition duration-200 ease-in-out`}
              ...
              {/* switch date */}
              <div className='flex flex-col text-white'>
                <p className='mb-2 text-sm'>Show date/time</p>
                <Switch
                  ...
                  className={`${
                    options.tweet.showDate ? 'bg-primary' : 'bg-[#212121]'
                  }
          relative inline-flex h-[20px] w-[52px] shrink-0 cursor-pointer items-center justify-self-end rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none  focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75`}>
                  <span className='sr-only'>Use setting</span>
                  <span
