...
const PricingHero = () => {
  ...
  return (
    <section className='w-[90%] md:w-[80%] mx-auto my-12'>
      <h2 className='text-white mb-6 font-semibold'>Pricing</h2>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
        <article>
          ...
          <div className='space-y-2 my-6 text-white text-sm md:text-base'>
            <p>
        ...
        <article className='flex md:justify-center items-center'>
          {user?.isPro ? (
            <p className='bg-primary text-center py-2 px-4 rounded-md animate-bounce'>
            ...
            <div className='md:text-center space-y-4'>
              <button
                ...
                className='inline-flex gap-2 items-center bg-primary hover:bg-green-500 p-6 text-2xl rounded-md text-bgGreen font-medium'>
                <svg
                  width='12'
                  height='16'
                  viewBox='0 0 10 14'
