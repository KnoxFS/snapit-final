    ...
    <section className='mx-auto my-12 w-[90%] md:w-[80%]'>
      ...
      <div className='grid grid-cols-1 gap-10 md:grid-cols-2'>
        <article>
          ...
          Screenshots4all is absolutely free to use, without any registration required.
          ...
          <div className='my-6 space-y-2 text-sm text-darkGreen dark:text-white md:text-base'>
            ...
            <p>
            Screenshots4all Pro is $7,99 a month, $79 annual or $99 for a perpetual
              (lifetime) license.
            </p>

            <p>
              <b>
                Every time you purchase Screenshots4all Pro , you also support our free
                plan - which helps keep Screenshots4all running.
              </b>
            </p>
          </div>
        </article>
