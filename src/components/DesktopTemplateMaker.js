...
import { desktopDevices as devices } from 'constants/devices';
...
const defaultOptions = {
  ...
  device: 'device device-macbook-pro-2018',
  ...
  const renderPreview = () => (
    <article className='flex h-full justify-center rounded-md bg-primary bg-opacity-20 p-8 dark:bg-opacity-10'>
      ...
      <div
        ...
        {options?.text.show && (
          <div
            className={`w-full ${options.text.align} ${
              options.text.position === 'top' ? 'mt-6' : 'mb-6'
            ...
            <div
              ...
              <div className='device-frame'>
                <img
                  ...
                  className='pointer-events-none h-full w-full select-none rounded-2xl bg-top'
                />
              </div>
        ...
        {/* watermark */}
        {options?.watermark && (
          <div className='absolute bottom-0 right-1/2 translate-x-1/2 select-none rounded-t-md bg-primary p-1 px-2 text-xs text-darkGreen dark:text-white'>
  ...
  const renderOptions = () => (
    <article className='custom-scrollbar max-h-[680px] overflow-y-auto overflow-x-hidden rounded-md bg-primary bg-opacity-20 p-4 dark:bg-opacity-10'>
      <div className='space-y-4'>
        ...
        {/* Add image */}
        <div className='flex items-center justify-between rounded-md bg-primary bg-opacity-30 p-2 font-medium text-darkGreen'>
          ...
          <label
            ...
            {blob.src && (
              <button
                ...
                className='absolute -right-1 -top-1 z-10 rounded-full bg-[#232323] p-0.5 shadow-md'>
        ...
        <div className='grid w-full grid-cols-[3fr,1fr]'>
          <div className='flex items-center space-x-2'>
            <DevicePhoneMobileIcon className='h-5 w-5 text-darkGreen dark:text-white' />
