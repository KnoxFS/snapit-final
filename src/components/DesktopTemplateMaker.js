            ...
            >
              <div className="device-frame">
                <img
                  ...
                  className="w-full h-full rounded-2xl bg-top pointer-events-none select-none"
                />
              </div>
  ...
  const renderOptions = () => (
    <article className="bg-[#2B2C2F] rounded-md p-4 overflow-y-auto overflow-x-hidden max-h-[680px] custom-scrollbar">
      <div className="space-y-4">
        ...
        {/* Add image */}
        <div className="bg-green-400 p-2 rounded-md text-white flex items-center justify-between">
          ...
          <label
            htmlFor="image"
            className={`cursor-pointer bg-[#232323] w-max p-2 rounded-md text-sm relative ${
          ...
          >
            ...
            {blob.src && (
              <button
                ...
                className="absolute -right-1 -top-1 bg-[#232323] shadow-md rounded-full p-0.5 z-10"
              >
        ...
        <div className="grid grid-cols-[180px,2em,1fr] w-full">
          <div className="flex items-center space-x-2">
            <DevicePhoneMobileIcon className="h-6 w-6 text-[#A0A0A0]" />

            <h3 className="text-sm text-gray-400">Device</h3>
          </div>
