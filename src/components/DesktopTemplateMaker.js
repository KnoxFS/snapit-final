  ...
  const renderOptions = () => (
    <article className='bg-primary bg-opacity-10 rounded-md p-4 overflow-y-auto overflow-x-hidden max-h-[680px] custom-scrollbar'>
      <div className='space-y-4'>
        <h3 className='text-center text-white w-full'>Device Options</h3>

        {/* Add image */}
        <div className='bg-primary p-2 rounded-md text-darkGreen font-medium flex items-center justify-between'>
        ...
        <div className='grid grid-cols-[3fr,1fr] w-full'>
          <div className='flex items-center space-x-2'>
            ...
            <h3 className='text-sm text-white'>Device</h3>
          </div>
