...
const Navbar = () => {
  ...
  return (
    <header className="my-4 w-[90%] md:w-[80%] mx-auto text-white flex items-center justify-between">
      {/* Logo */}
      <Link href="/">
        <a>
          <img src="/Snapit.png" className="w-24 md:w-36" />
        </a>
      </Link>

      <nav className="hidden md:block space-x-6 text-sm">
        <Link href="/">
      ...
      <div className="flex items-center space-x-3">
        ...
        {!user && (
          <div className="flex items-center space-x-3 text-sm">
            ...
            <Link href="/signup">
              <a className="bg-green-400 py-2 px-6 rounded-md hover:bg-green-500 transition">
                Sign up
              </a>
            </Link>
          </div>
        ...
        {/* mobile navbar */}
        <Menu as="div" className="md:hidden ml-4 relative">
