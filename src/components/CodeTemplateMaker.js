...
const TemplateMaker = ({ proMode }) => {
  ...
  const renderOptions = () => (
    <Tab.Group as="div" id="tabs" className="relative">
      ...
      <Tab.List className="absolute w-52 rotate-90 top-1/2 -right-[117px] px-6 py-1 cursor-pointer rounded-t-xl bg-[#2B2C2F] text-white text-sm flex flex-row justify-between">
        <Tab
          as="button"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 w-full">
                <div className="flex items-center space-x-2">
                  <CodeBracketIcon className="h-6 w-6 text-[#A0A0A0]" />
                ...
                <select
                  ...
                  className="bg-green-400 p-2 text-dark font-semibold rounded-md cursor-pointer text-sm custom-scrollbar-sm outline-none"
                >
                  {langNames.map((lang) => (
              ...
              <div className="grid grid-cols-2 w-full">
                <div className="flex items-center space-x-2">
                  <Bars3Icon className="h-6 w-6 text-[#A0A0A0]" />
                ...
                <select
                  ...
                  className="bg-green-400 p-2 text-dark font-semibold rounded-md text-sm cursor-pointer custom-scrollbar-sm outline-none"
                >
                  ...
                  <>
                    <Disclosure.Button className="w-full">
                      <div className="grid grid-cols-[180px,2em,1fr] w-full">
                        <div className="flex items-center space-x-2">
                          <BarsArrowUpIcon className="h-6 w-6 text-[#A0A0A0]" />

                          <h3 className="text-sm text-gray-400">Font Size</h3>
                        </div>
              ...
              <div className="space-y-4">
                ...
                {user && user.isPro && (
                  <button
                    className="flex items-center justify-center px-4 py-2 w-full text-base bg-green-400 rounded-md text-white"
