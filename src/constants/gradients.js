...
export const gradientDirections = [
  {
    ...
    icon: <ArrowUpIcon className="w-4 h-4 text-white" />,
  },
  {
    value: "bg-gradient-to-tr",
    icon: <ArrowUpRightIcon className="w-4 h-4 text-white" />,
  },
  {
  ...
  },
  {
    ...
    icon: <ArrowDownRightIcon className="w-4 h-4 text-white" />,
  },
  {
    value: "bg-gradient-to-b",
    icon: <ArrowDownIcon className="w-4 h-4 text-white" />,
  },
  {
    value: "bg-gradient-to-bl",
    icon: <ArrowDownLeftIcon className="w-4 h-4 text-white" />,
  },
  {
    value: "bg-gradient-to-l",
    icon: <ArrowLeftIcon className="w-4 h-4 text-white" />,
  },
  {
    value: "bg-gradient-to-tl",
    icon: <ArrowUpLeftIcon className="w-4 h-4 text-white" />,
  },
];
